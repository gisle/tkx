...
the context of that callback.  The description of yTk::I<foo> below
...
If this mapping does not suit you, use C<< yTk::i::call($func, @args)
...
elements as arguments when invoked.  The yTk::Ev() function can be
